    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          <div className="mb-12">
            <h1 className="text-2xl font-bold text-balance mb-2">MD Faiaz Fahim</h1>
            <p className="text-muted-foreground text-sm">VR Developer & 3D Artist</p>
          </div>
          ...
          <div className="flex gap-4 mt-8">
            <a
              href="https://www.linkedin.com/in/md-faiaz-fahim/"
              target="_blank"
            ...
            <a
              href="https://www.artstation.com/faiaz_fahim"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-primary transition-colors"
            >
            ...
            <a
              href="https://www.behance.net/faiazfahim"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-primary transition-colors"
            >
